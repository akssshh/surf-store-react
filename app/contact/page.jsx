...
const Contact = () => {
  return (
    <>
      <section className="bg-white py-20 lg:py-[120px] flex justify-center items-center h-screen overflow-hidden relative z-10">
          ...
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form
                  action="https://formspree.io/f/xyyqebqn"
                  method="POST"
                >
                  <ContactInputBox
                    type="text"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white bg-customColor transition border rounded border-primary bg-primary hover:bg-button-clr "
                    >
                      Send Message
                    </button>
                  </div>
