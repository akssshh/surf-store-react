...
import SurfLogo from "../public/Surf-Logo.png"
                    ...
                    <div className="dark:bg-gray-900 bg-gray-50 px-6 py-4">
                        <div className="container mx-auto flex items-center justify-between">
                            <h1 className="md:w-2/12 cursor-pointer text-gray-800 dark:text-white" aria-label="the Crib.">
                                <Image src={SurfLogo} width={60} height={60} alt="surf-logo" />
                                    <path
                            ...
                            <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8">
                                ...
                                <li>
                                    <Link href="/contact" className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        CONTACT
                                    </Link>
                                </li>
                            </ul>
